...
<div class="lefttop"><span></span>工具</div>
...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="/userController" target="rightFrame">用户管理</a><i></i></li>
            <li class="active"><cite></cite>
                <a href="/bookController?type=query" target="rightFrame">书籍管理</a><i></i></li>
